...
{
    pub fn gui_id_by_name<'m, T: 'static + DebugGuiBase<'m>>(name: &str) -> DebugMenuId
    {
    ...
    #[inline]
    pub fn gui_id<'m, T: 'static + DebugGuiBase<'m>>(gui: &'m T) -> DebugMenuId
    {
        Self::gui_id_by_name::<T>(gui.name())
    }

    fn get_or_create_state<'m, T: 'static + DebugGuiBase<'m>>(&mut self, gui: &'m T) -> &mut DebugMenuItemState
    {
    ...
    pub fn set_active<'m, T: 'static + DebugGuiBase<'m>>(&mut self, gui: &'m T, activate: bool)
    {
        self.get_or_create_state(gui).is_active = activate;
    }

    pub fn set_active_by_name<'m, T: 'static + DebugGuiBase<'m>>(&mut self, name: &str, activate: bool)
    {
    ...
    pub fn toggle_active<'m, T: 'static + DebugGuiBase<'m>>(&mut self, gui: &'m T) -> Option<bool>
    {
        let gui_id = Self::gui_id(gui);
...
impl<'m> DebugMenu<'m>
{
    ...
    pub fn add<T: 'static + DebugGuiBase<'m>>(&mut self, gui: &'m T)
    {
        // todo: sorted dict
