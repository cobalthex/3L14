use wgpu::*;
use crate::engine::middlewares::graphics;
use crate::engine::middlewares::graphics::renderer::RenderFrame;

pub fn test(frame: &mut RenderFrame, clear_color: Option<graphics::colors::Color>) -> RenderPass
{
